CREATE DATABASE [Hotel3]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Hotel3', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.ASUS\MSSQL\DATA\Hotel3.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Hotel3_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.ASUS\MSSQL\DATA\Hotel3_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [Hotel3] SET COMPATIBILITY_LEVEL = 150
GO
...
GO
ALTER DATABASE [Hotel3] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Hotel3] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Hotel3] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
GO
ALTER DATABASE [Hotel3] SET  DISABLE_BROKER 
GO
...
GO
ALTER DATABASE [Hotel3] SET RECOVERY FULL 
GO
...
USE [Hotel3]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [Hotel3] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
